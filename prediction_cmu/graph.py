...
class Graph():
    ...
    def get_edge(self):
        ...
        # bone
        self.bone_num_node = 25
        self_link = [(i, i) for i in range(self.bone_num_node)]
        neighbor_link_ = [(1, 2), (2, 3), (4, 5), (5, 6), (7, 9), (8, 9), (9, 10), (10, 11),
                          (10, 14), (11, 12), (12, 13), (14, 15), (15, 16), (16, 17), (16, 19),
                          (17, 18), (20, 21), (21, 22), (22, 23), (22, 25)]
